  ...
  Widget build(BuildContext context) {
                            ...
                            if(_emailTextEditingController.text.trim().isNotEmpty && _passwordTextEditingController.text.trim().isNotEmpty)
    {
      ...
      try{
        ...
        CustomSnackbar.showCustomSnackbar(message: "User Register Susccefully",
         context: context,);
      ...
      on FirebaseAuthException catch(error){
        CustomSnackbar.showCustomSnackbar(message: error.message!,
         context: context,);
      }
      
    }
    else{
      CustomSnackbar.showCustomSnackbar(message: "Please Enter Valid Fields",
       context: context,);
    }
