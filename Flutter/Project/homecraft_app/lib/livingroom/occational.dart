...
class Occational extends StatefulWidget {
  const Occational({super.key});

  @override
  State<Occational> createState() => _SofaScreenState();
}

class _SofaScreenState extends State<Occational> {
