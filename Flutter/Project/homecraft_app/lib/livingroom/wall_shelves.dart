...
class WallShelves extends StatefulWidget {
  const WallShelves({super.key});

  @override
  State<WallShelves> createState() => _SofaScreenState();
}

class _SofaScreenState extends State<WallShelves> {
